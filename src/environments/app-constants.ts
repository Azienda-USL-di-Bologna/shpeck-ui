...
export const BaseUrls: Map<BaseUrlType, string> = new Map<BaseUrlType, string>([
  ...
  [
    BaseUrlType.ConfigurazioneImpostazioniApplicazioni,
    "/internauta-api/resources/configurazione/custom/setImpostazioniApplicazioni",
  ],
...
export const CUSTOM_SERVER_METHODS = {
  ...
  fixMessageTagInRegistration: "fixMessageTagInRegistration",
};
