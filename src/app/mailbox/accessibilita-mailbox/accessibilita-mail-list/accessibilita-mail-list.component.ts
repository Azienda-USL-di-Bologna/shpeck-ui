    ...
    switch (name) {
      ...
      case "onContextMenuSelect":
        ...
        setTimeout(() => {
          ...
          console.log("CHE E'???", this.mailListService.selectedMessages);
        }, 0);
        break;
      case "saveNote":
        this.saveNote();
  ...
  private saveNote() {
    ...
    this.mailListService.saveNoteAndUpdateTag(this.noteObject).subscribe(
      (res: BatchOperation[]) => {
        ...
        this.messagePrimeService.add({ severity: "success", summary: "Successo", detail: "Nota salvata correttamente" });
      },
      (err) => {
        console.log("ERR = ", err);
