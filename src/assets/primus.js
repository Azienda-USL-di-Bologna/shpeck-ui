              ...
              Primus.prototype.client = function client() {
                ...
                if (!factory)
                  return primus.critical(
                    new Error("Missing required `engine.io-client` module. " + "Please run `npm install --save engine.io-client`")
                  );
                ...
                primus.on("outgoing::open", function opening() {
                  ...
                  primus.socket = socket = factory(
                    primus.merge(primus.transport, primus.url, primus.uri({ protocol: "http:", query: true, object: true }), {
                      //
        ...
        return (function () {
        ...
        })()(
          {
            ...
            4: [
              ...
              { "component-emitter": 14, "engine.io-parser": 16 },
            ],
            5: [
              function (_dereq_, module, exports) {
                /**
            ...
            6: [
              ...
              { "./polling": 8, "component-inherit": 15 },
            ],
            7: [
              function (_dereq_, module, exports) {
                /* global attachEvent */
              ...
              { "./polling": 8, "component-emitter": 14, "component-inherit": 15, "xmlhttprequest-ssl": 10 },
            ],
            8: [
              function (_dereq_, module, exports) {
                /**
